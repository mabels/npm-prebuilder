            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        rect = geo_rect_google_1.GeoRectGoogle.from(bounds, { mapImplementation: this });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        rect = geo_rect_google_1.GeoRectGoogle.create(bounds, { mapImplementation: this });
    ...
    GeoMapGoogle.prototype.coversLocation = function (point) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = geo_rect_google_1.GeoRectGoogle).create;
...
exports.GeoMapGoogle = GeoMapGoogle;
