...
module.exports = options => new Promise(function ($return, $error) {
  return $return(function main(req, res) {
    return new Promise(function ($return, $error) {
      var config, cwd, _options$config$entry, entry, _ref, _ref2, docs, patterns;
      ...
      try {
        ...
        return Promise.all([loadDocsTree({
          ...
          _ref = $await_4, _ref2 = _slicedToArray(_ref, 2), docs = _ref2[0], patterns = _ref2[1].patterns;
          res.send({
            config,
            docs,
            meta: {
