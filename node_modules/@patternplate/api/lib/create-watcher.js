...
module.exports.createWatcher = function createWatcher(options) {
  return new Promise(function ($return, $error) {
    ...
    const _config$entry = config.entry,
          entry = _config$entry === void 0 ? [] : _config$entry,
          _config$docs = config.docs,
          docs = _config$docs === void 0 ? [] : _config$docs;
        ...
        (() => new Promise(function ($return, $error) {
          ...
          return loadMeta({
            ...
            if (meta.errors && meta.errors.length > 0) {
              meta.errors.forEach(error => next({
                type: "error",
                payload: error
              }));
            }
            ...
            parents = getParents({
              globs: [...entry, ...docs],
              paths: [configPath, meta.patterns.length > 0 ? commonDir(meta.patterns.map(m => Path.join(cwd, m.path))) : null].filter(Boolean)
            }, {
              cwd
            });
            ...
            obs.watcher = watcher;
            watcher.on("all", (e, p) => new Promise(function ($return, $error) {
...
function getParents({
  ...
  return [...paths, ...globs.filter(g => g.charAt(0) !== "!").map(g => Path.join(cwd, globParent(g)))];
}
