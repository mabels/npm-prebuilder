...
var _default = (0, _promiseThunkAction.createPromiseThunkAction)("LOAD_SCHEMA", (_, __, getState) => new Promise(function ($return, $error) {
  var response;
  return (0, _fetch.default)(`${prefix(getState().base)}/api/state.json`).then(function ($await_1) {
    response = $await_1;
