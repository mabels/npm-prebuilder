...
var _handleDependentActions = _interopRequireDefault(require("./handle-dependent-actions"));
...
const asyncIdent = i => new Promise(function ($return, $error) {
  return $return(i);
}.$asyncbind(void 0));
...
function createPromiseThunkAction(name, rawCreator) {
  ...
  const fn = payload => {
    ...
    return (dispatch, getState) => new Promise(function ($return, $error) {
...
function handlePromiseThunkAction(rawName, handler, options = {}) {
  ...
  const reducer = (0, _handleDependentActions.default)({
...
//# sourceMappingURL=promise-thunk-action.js.map