...
var _loadPatternDemo = _interopRequireDefault(require("./load-pattern-demo"));

var _loadSchema = _interopRequireDefault(require("./load-schema"));
...
var _default = (0, _promiseThunkAction.createPromiseThunkAction)("LISTEN", (payload, dispatch, getState) => {
  ...
  const source = _url.default.resolve(state.base, payload.url);
  ...
  ws.onMessage(envelope => new Promise(function ($return, $error) {
    const message = _arson.default.parse(envelope.data);
    ...
    switch (type) {
      ...
      default:
        return $error(new TypeError(`Received unknown message of type ${type}`));
    }
