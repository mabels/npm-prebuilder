...
domTestingLibrary.fireEvent.mouseEnter = domTestingLibrary.fireEvent.mouseOver;
domTestingLibrary.fireEvent.mouseLeave = domTestingLibrary.fireEvent.mouseOut;

domTestingLibrary.fireEvent.select = function (node, init) {
  ...
  domTestingLibrary.fireEvent.keyUp(node, init);
