(function (global, factory) {
  ...
  */
  ...
  function prettyDOM(htmlElement, maxLength, options) {
    ...
    var debugContent = prettyFormat(htmlElement, _extends$1({
  ...
  function queryAllByLabelText(container, text) {
    ...
    var matchOpts = { collapseWhitespace: collapseWhitespace, trim: trim };
    var labels = queryAllLabelsByText(container, text, _extends$1({ exact: exact }, matchOpts));
    ...
    var possibleAriaLabelElements = queryAllByText(container, text, _extends$1({
      exact: exact
  ...
  */
  ...
  Object.keys(eventMap).forEach(function (key) {
    ...
    fireEvent[key] = function (node, init) {
      var eventInit = _extends$1({}, defaultInit, init);
