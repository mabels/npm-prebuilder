...
function resolveExtends() {
	...
	var extended = loadExtends(config, context).reduceRight(function (r, c) {
		return (0, _lodash.merge)(r, (0, _lodash.omit)(c, 'extends'));
	}, e ? { extends: e } : {});
...
function loadExtends() {
	...
	return (config.extends || []).reduce(function (configs, raw) {
		...
		var ctx = (0, _lodash.merge)({}, context, {
			cwd: _path2.default.dirname(resolved)
		});
...
function resolveId(id) {
	...
	return (0, _resolveFrom2.default)(context.cwd || process.cwd(), id);
}
