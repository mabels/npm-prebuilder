import { GraphQLInputType, GraphQLObjectType, GraphQLType, GraphQLResolveInfo, GraphQLFieldConfig } from 'graphql';
...
export declare function typeWrapper<T extends GraphQLObjectAbstractType>(t: T): TypeWrapperGraphQLType<T>;
